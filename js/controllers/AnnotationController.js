// var annotation_image_id = "#annotation_image"
...
app.controller('AnnotationController', ['$scope', function($scope) {
    ...
    $scope.nextImage = function(){
        ...
        if(firstImage){
            ...
            if(annotation_state.prev_annotations.length > 0){
                $("#annotation_image").attr("src", annotation_state.current_annotation.location);
            }
            ...
            anno.makeAnnotatable(document.getElementById('annotation_image'));
        ...
        if(annotation_state.next_annotations.length > 0){
            ...
            child.attr("id", "annotation_image");
            child.height("inherit");//height="42" width="42"
            child.width("inherit");
